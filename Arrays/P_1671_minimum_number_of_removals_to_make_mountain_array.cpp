...
// this is solved with the help of solved with LIS.
// Important: I thought of doing it with the help of stacks but failed and realised that stacks cant's be used for LIS just a silly doubt